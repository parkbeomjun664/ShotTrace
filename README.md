...
**현재 상태** — 🚧 개발 중 (2026-08 시작, **2026-11 완성 목표**)
...
| 시기 | 목표 |
|---|---|
| 2026-09 | 화면 완성 + 파이프라인 앞단 — View/RPC · 차트 · 시뮬레이터 · MQTT |
| 2026-10 | 파이프라인 완성 + 기록 — 수집기 · 실시간 **MVP** · 인증 · 실적 입력 |
| 2026-11 | 마감 — OEE · 테스트 · 성능 · CI · 문서 → **11/26 완성** |
| 2026-12 | 여유 — 밀린 것 흡수 · 안 밀렸으면 개선 |
| 2027-01~02 | 공부하고 개선한다 — 전체 복습 · 성능 심화 · 설명 훈련 |
